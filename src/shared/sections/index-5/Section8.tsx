...
const TEAM_MEMBERS = [
    {
        ...
        img: "/assets/imgs/pages/webp-images/1.webp",
        link: "https://www.instagram.com/p/DSM_AO2DzX5/",
        fabClass: "sec-6-home-10__member-fab--light",
        delay: "0.1",
    },
    {
        nameFirst: "E-commerce",
        nameLast: "Automation",
        role: "AI & E-commerce",
        img: "/assets/imgs/pages/webp-images/3.webp",
        link: "https://www.instagram.com/p/DOoS0xxDZCd/",
        fabClass: "sec-6-home-10__member-fab--light",
        delay: "0.12",
    },
    {
        ...
        img: "/assets/imgs/pages/webp-images/cover.webp",
        link: "https://www.instagram.com/p/DcWAGFpNIny/",
    ...
    },
    {
        ...
        img: "/assets/imgs/pages/webp-images/4.webp",
        link: "https://www.instagram.com/p/DUqZhCMj7JU/",
        fabClass: "sec-6-home-10__member-fab--light",
        delay: "0.16",
    },
];
            ...
            <div className="sec-6-home-10__container">
                <div className="sec-6-home-10__layout">
                        ...
                        <div className="sec-6-home-10__eyebrow d-inline-flex align-items-center gap-2 at_fade_anim" data-delay="0.05">
                            <span className="at-btn common-black bg-transparent mb-10 rounded-0 p-0">
                                <span className="text-uppercase">
                                    <span className="text-1">Explore Now</span>
                                    <span className="text-2">Explore Now</span>
                                </span>
                                <i><DoubleArrowIcon /></i>
                            </span>
                        </div>
                        <h2 className="sec-6-home-10__title mt-3 mb-0 at_fade_anim reveal-text" data-delay="0.08">
                            <RevealText>Discover My Content</RevealText>
                        </h2>
                    </header>
                    ...
                    <div className="sec-6-home-10__foot at_fade_anim" data-delay="0.18">
                        <p className="sec-6-home-10__foot-text mb-0 reveal-text"> <RevealText>I build AI and SaaS products, drive growth through sales and marketing, and create automation systems that help businesses scale.</RevealText> </p>
                        <Link
