...
const QUOTE_TEXT = (
    <>
        Have something you’re trying to build, improve, or figure out? Let’s see where we can take it.
    </>
);
                    ...
                    <div className="col-xxl-8 mx-auto">
                        ...
                        <div className="justify-content-center d-flex mt-50">
                            ...
                            >
                                ...
                                <Link className="at-btn z-index-1" to="https://calendar.app.google/8o7kWArjFZQchGAEA">
                                    Get in touch
                                </Link>
                                <Link
                                    className="at-btn-circle"
